...
use poker_eval::web::{flop_analyzer, PlayerPreFlopState};
...
fn main() {
    ...
    analyzer
        .set_player_cards(0, &Board::try_from("Ks 6s").unwrap().as_vec_u8())
        .unwrap();
    analyzer.set_player_range(1, "22+,A2s+,K2s+,Q2s+,J2s+,T2s+,92s+,82s+,74s+,64s+,54s,A2o+,K2o+,Q2o+,J2o+,T2o+,94o+,85o+,75o+").unwrap();
    analyzer
        .set_player_range(2, "33+,A2s+,K3s+,Q6s+,J8s+,T9s,A2o+,K6o+,Q8o+,JTo")
        .unwrap();
