...
pub const RANK_BASES: [u64; NUMBER_OF_RANKS] = [
    ...
    390_625, 1_953_125, 9_765_625, 48_828_125, 
    244_140_625,
...
mod tests {
    ...
    fn test_value_suit_masks() {
        ...
        for suit in 0..4 {
            ...
            info!("All set bits for {} suit = {:0>64b} {:x}", suit, all_set_bits, all_set_bits);
            ...
            info!("Suit bit? {:0>64b} {:x} {} leading zeros {} trailing zeros {} flush suit {}", 
            set_suit_bit, set_suit_bit,
            suit_check,
             set_suit_bit.leading_zeros(), set_suit_bit.trailing_zeros(), flush_suit);
