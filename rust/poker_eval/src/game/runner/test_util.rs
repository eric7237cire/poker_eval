...
use super::{GameLogSource, GameLog, GameRunnerSourceEnum, GameRunnerDecoupled, GameRunnerSource, GameRunner};


pub fn run_gamelog(game_log: GameLog) -> GameRunnerDecoupled{
    ...
    let mut game_runner = GameRunnerDecoupled::new(game_source.get_initial_players(), game_source.get_small_blind(),
