...
const suitClasses = ['text-green-600', 'text-blue-600', 'text-pink-600', 'text-black'];
...
export const colorString = (color: { red: number; green: number; blue: number }) => {
...
export const sanitizeBetString = (s: string, is_raise: boolean): { s: string; valid: boolean } => {
